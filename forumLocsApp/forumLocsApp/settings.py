"""
Django settings for forumLocsApp project.
...
SECRET_KEY = '#5$3q2fn+5$*d6l%c6bw*u!6_2__3w%p@$o6emhm$u-q(j)ani'
...
ROOT_URLCONF = 'forumLocsApp.urls'
...
WSGI_APPLICATION = 'forumLocsApp.wsgi.application'
